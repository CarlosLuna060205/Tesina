...
def simulador_maestro_hpd():
    ...
    M = 50 #número de trayectorias independientes observadas.
    ...
    print(f"Iniciando {num_experimentos} simulaciones con calculo HPD (esto puede tomar unos segundos)...")
    print("-" * 70)
    ...
    for i in range(num_experimentos):
        ...
        # SUSTITUCION CLAVE: Uso de la funcion HPD en lugar de intervalos simetricos
    ...
    print(f"RESULTADOS DE COBERTURA FRECUENTISTA (Intervalos HPD de Minima Longitud al 95%):")
    ...
    fig.suptitle('Validacion Empirica: Cobertura de Intervalos HPD del 95%', fontsize=16)
    ...
    for idx, (llave, valor_real, titulo) in enumerate(parametros):
        ...
        ax.set_ylabel('Valor Estimado HPD')
    ...
    fig.legend(handles=[leyenda_negra, leyenda_azul, leyenda_roja], loc='upper right', bbox_to_anchor=(0.99, 0.99))
    
    plt.tight_layout(rect=[0, 0, 1, 0.95])
    plt.savefig('cobertura_intervalos_hpd.pdf', format='pdf', bbox_inches='tight')
    plt.show()

simulador_maestro_hpd()